...
namespace ConsoleApp1
{
    class Program
    {
        ...
        {
            Print("Вас приветствует программа демонстрации возможностей статического класса Message.");

            Print("\nИмеется следующий текст: \n" + Message.text);

            Print("\nВыведем слова текста, которые содержат не более 5 букв:");

            Message.GetWordsLenght(5);

            Print("\nВыведем слова текста, которые содержат на конце букву 'л' ");

            Message.DeleteWordByEndChar('л');

            Print("\nСамое длинное слово: " + Message.FindMaxLengthWord());
